...
// ---- НОВЫЕ ПУБЛИЧНЫЕ ФУНКЦИИ ДЛЯ АПСЕМПЛИНГА ----
uint8_t IsUpsamplingEnabled(void);     /*!< Проверяет, включен ли режим апсемплинга. Возвращает 1, если да, иначе 0. */
uint8_t GetUpsampleAlgo(void);         /*!< Возвращает выбранный алгоритм апсемплинга (0 или 1). */
